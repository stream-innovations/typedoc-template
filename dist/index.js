...
function load(app) {
    ...
    app.listenTo(app.renderer, typedoc_1.RendererEvent.END, () => {
        const from = (0, path_1.resolve)(__dirname, '../assets/theme.css');
        const to = (0, path_1.resolve)(app.options.getValue('out'), 'assets/theme.css');
        (0, fs_1.cpSync)(from, to);
    });
    app.renderer.defineTheme('streamprotocol', StreamProtocol_1.StreamProtocol);
}
exports.load = load;
;